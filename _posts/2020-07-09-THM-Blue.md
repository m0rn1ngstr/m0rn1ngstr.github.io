...
After quick googling we get this [Microsoft Windows 7/8.1/2008 R2/2012 R2/2016 R2 - 'EternalBlue' SMB Remote Code Execution (MS17-010)](https://www.exploit-db.com/exploits/42315)
<figure>
...
So now we need to set SESSIONS to number of our session, which is in background, in my case it is 2. If not sure, use *sessions -l* command. Then run it.
